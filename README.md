...
- Optimized modeling pipeline: key features selected via RFECV with Extra Trees Classifier, hyperparameters tuned using Bayesian Optimization, and data balanced with SMOTE.
